  ...
  methods: {
    ...
    getDate() {
      api_statistice.selectAgentDataByPage({
        ...
        // console.log(res)
        this.configData[0].prop = res.datas.agentName
        this.configData[1].prop = res.datas.agentName
        this.configData[2].prop = res.datas.contact
        this.configData[3].prop = res.datas.settleAccount
        this.configData[4].prop = res.datas.totalCommission
        this.configData[5].prop = res.datas.alipayCommission
        this.configData[6].prop = res.datas.wechatCommission
        this.configData[7].prop = res.datas.cloudPayCommission
        this.configData[8].prop = res.datas.unionpayTradeAmount
        this.configData[9].prop = res.datas.activityReward
        console.log(res)
      }).catch(err => {
        console.log(err)
      })
