<template>
  <div class="main_page">
    <Search :is-show-all="farst" :open-height="searchHeight" :form-base-data="searchConfig.formData" @search="search" />
    <div class="table_box">
...
export default {
  ...
  methods: {
    ...
    search($ruleform) {
      this.params = {
        agentNo: $ruleform.inputSelect === 'merchantNo' && $ruleform.inputForm ? $ruleform.inputForm : this.$route.query.agentNo,
