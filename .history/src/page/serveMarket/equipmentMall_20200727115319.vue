  ...
  <div class="main_page">
    ...
    <div v-else>
      ...
      <div class="equiment_list">
        <div  v-for="(item, index) in mallList.FACE" class="list" :key="index" @click.stop="onclick_todetail(item.deviceId)">
          <div class="list_img">
            <img src="" alt="">
          </div>
      ...
      <div class="equiment_list">
        <div v-for="(item, index) in mallList.POSS" :key="index" @click.stop="onclick_todetail(item.deviceId)" class="list">
          <div class="list_img">
